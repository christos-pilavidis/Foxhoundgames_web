export interface ContactBoxProps {
  title: string;
  email: string; // Only email property now.
}

export function ContactBox({ title, email }: ContactBoxProps) {
  return (
    <div className="contact-box hidden flex-none items-center gap-4 text-accent-900 dark:text-white xl:flex">
      ...
      <div>
        ...
        <a
          href={`mailto:${email}`}
          className="block font-secondary text-base font-bold leading-[1.3]"
        >
          {email}
        </a>
      </div>
